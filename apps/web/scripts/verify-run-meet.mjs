...
eq(cta({ status: 'closed' }), { label: '已關閉', action: 'none', disabled: true, variant: 'muted' }, '非成員｜已關閉')
eq(cta({ status: 'cancelled' }), { label: '已取消', action: 'none', disabled: true, variant: 'muted' }, '非成員｜已取消')
