...
// ⚠️ 最容易寫錯的兩個邊界：中午 12:xx 是「下午 12:xx」、凌晨 0:xx 是「凌晨 0:xx」
// （中文口語不說「上午 12 點半」，那會被讀成中午；見 lib/runMeet.ts fmtHour12）
...
eq(fmtMeetAt('2026-08-29T16:00:00.000Z', new Date('2026-08-29T10:00:00+08:00')), '8/30（日）凌晨 0:00', 'fmtMeetAt 邊界｜0:00（台北）→ 凌晨 0:00，不是「上午 12:00」')
eq(fmtMeetAt('2026-08-29T16:30:00.000Z', new Date('2026-08-29T10:00:00+08:00')), '8/30（日）凌晨 0:30', 'fmtMeetAt 邊界｜0:30（台北）→ 凌晨 0:30')
eq(fmtMeetAt('2026-08-29T17:00:00.000Z', new Date('2026-08-29T10:00:00+08:00')), '8/30（日）上午 1:00', 'fmtMeetAt｜1:00 仍是上午（凌晨只用在 0 點那一小時）')
