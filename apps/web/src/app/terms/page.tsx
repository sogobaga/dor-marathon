      ...
      <div style={body}>
        ...
        <div style={notice}>
          ...
          <div style={{ fontSize: 13, color: 'var(--tx)', lineHeight: 1.75 }}>
            本平台之雲端馬拉松為「特定期間提供之線上活動／數位服務」，<b>一經報名繳費完成即開通參賽資格，恕不退款</b>；
        ...
        <H>退款政策</H>
        <ul style={ul}>
          <li>雲端馬拉松賽事屬<b>線上活動／數位服務</b>，於特定期間提供，報名繳費完成即開通參賽資格。</li>
        ...
        <H>服務條款</H>
        <ol style={ol}>
          <li><b>服務內容</b>：DOR 雲端馬拉松（dor.hero-mi.com）為線上路跑／挑戰賽事的報名與運動數據追蹤平台，提供賽事報名、運動數據連接（如 Strava）、任務、排行榜與等級系統。</li>
        ...
        <div style={{ textAlign: 'center', marginTop: 28, fontSize: 12, color: 'var(--tx-faint)' }}>
          DOR · 雲端馬拉松　·　<a href="/privacy" style={link}>隱私權政策</a>　·　<a href="/support" style={link}>支援與聯絡</a>
        </div>
      </div>
      </ScrollArea>
    </PhoneFrame>
