...
export const EFFECT_SPECS: EffectSpec[] = [
  ...
  { slug: 'interaction.shape.bg3', category: '圖形魔法陣底圖', label: '三角形 魔法陣底圖', where: '畫「三角形」時的底圖（未上傳則只有幾何虛線）', type: 'image', placeholder: '（幾何虛線）', size: '512 × 512 px（正方）', format: 'PNG（去背透明）', maxKB: 200, note: '圖中三角形「頂點朝上、置中」；虛線大小用下方「導引縮放」對齊底圖線條' },
